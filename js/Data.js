define([
     ...
     */
     WeatherData.prototype.getData = function(callback) {
        ...
        // this.city = city;
        //请求指定地区数据
        var url = "https://cors.quickso.cn/https://yiketianqi.com/api?version=v1&appid=85593735&appsecret=ddofpk21&city=" + this.city;
        // var url = "https://v0.yiketianqi.com/api?version=v9&appid=85593735&appsecret=ddofpk21&city=" + this.city;
        //请求定位地区数据
        if (this.city === "") {
            url = "https://cors.quickso.cn/https://yiketianqi.com/api?version=v1&appid=85593735&appsecret=ddofpk21";
    ...
    WeatherData.prototype.getLifeIndex = function(callback) {
        var that = this;
        var url = "https://cors.quickso.cn/https://yiketianqi.com/life/life?appid=85593735&appsecret=ddofpk21";
        axios.get(url)
        .then(function(response) {
            //存储
            that.city = response.data.city;
